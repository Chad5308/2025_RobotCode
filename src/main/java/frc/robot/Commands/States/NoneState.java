...
public class NoneState extends Command 
{
    ...
    public NoneState(StateMachine s_StateMachine, DriveCommand c_Drive, Elevator s_Elevator, Climber s_Climber, AlgaeRollers s_Rollers, Vision s_Vision, Lights s_Lights) 
    {
