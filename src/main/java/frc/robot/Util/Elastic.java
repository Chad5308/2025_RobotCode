...
public final class Elastic {
    ...
    public Elastic(Drive s_Drive)
    {
        ...
        public void initSendable(SendableBuilder builder) {
            ...
            builder.addDoubleProperty("Front Left Angle", () -> s_Drive.modules[0].getAngle().getRadians(), null);
            builder.addDoubleProperty("Front Left Velocity", () -> s_Drive.modules[0].getVelocityMetersPerSec(), null);

            builder.addDoubleProperty("Front Right Angle", () -> s_Drive.modules[1].getAngle().getRadians(), null);
            builder.addDoubleProperty("Front Right Velocity", () -> s_Drive.modules[1].getVelocityMetersPerSec(), null);

            builder.addDoubleProperty("Back Left Angle", () -> s_Drive.modules[2].getAngle().getRadians(), null);
            builder.addDoubleProperty("Back Left Velocity", () -> s_Drive.modules[2].getVelocityMetersPerSec(), null);

            builder.addDoubleProperty("Back Right Angle", () -> s_Drive.modules[3].getAngle().getRadians(), null);
            builder.addDoubleProperty("Back Right Velocity", () -> s_Drive.modules[3].getVelocityMetersPerSec(), null);

            builder.addDoubleProperty("Robot Angle", () -> s_Drive.getRotation().getRadians(), null);
        }
        });
        ...
        SmartDashboard.putData("Field", new Sendable()
        {
            ...
            public void initSendable(SendableBuilder builder)
            {
                ...
                builder.addDoubleProperty("X", ()->s_Drive.getPose().getMeasureX().magnitude(), null);
